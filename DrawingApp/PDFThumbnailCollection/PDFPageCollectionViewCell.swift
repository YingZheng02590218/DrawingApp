...
internal final class PDFPageCollectionViewCell: UICollectionViewCell {
    ...
    func setup(_ indexPathRow: Int, collectionViewBounds: CGRect, document: PDFDocumentForList, pageCollectionViewCellDelegate: PDFPageCollectionViewCellDelegate?) {
