...
extension PDFViewController {
    ...
    public class func createNew(with document: PDFDocumentForList, title: String? = nil, actionButtonImage: UIImage? = nil, actionStyle: ActionStyle = .print, backButton: UIBarButtonItem? = nil, isThumbnailsEnabled: Bool = true, startPageIndex: Int = 0) -> PDFViewController {
        let storyboard = UIStoryboard(name: "PDFViewController", bundle: Bundle(for: PDFViewController.self))
...
public class PDFViewController: UIViewController {
    ...
    private var document: PDFDocumentForList!
